...
public class PartyMemberRepository : BaseRepository<PartyMember>, IPartyMemberRepository
{
    ...
    public PartyMemberRepository(AppDbContext db) : base(db)
    {
     ...
     private IQueryable<PartyMember> ApplySortDirection(IQueryable<PartyMember> query, string filter, string sortDirection)
     {
     ...
     private IQueryable<PartyMember> ApplyDateFilters(IQueryable<PartyMember> query, QueryParams<PartyMember> queryParams)
     {
