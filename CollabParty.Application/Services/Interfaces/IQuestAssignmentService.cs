...
public interface IQuestAssignmentService
{
    ...
    Task<Result> UpdateQuestAssignments(int questId, string[] updatedPartyMemberIds);
    Task<Result> DeleteQuestAssignments(int questId, string[] partyMemberIdsToDelete);
}